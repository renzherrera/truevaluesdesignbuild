...
<div class="tab-content">
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card card pb-3 mb-2">
            <div class="card-body"><h5 class="card-title">Edit Personal Information</h5>
                <input type="text" name="selected_id" id="selected_id" wire:model="selected_id" hidden readonly>

                    <label for="exampleEmail11" class="mt-2">Photo</label>

                    <div class="form-row mb-3">
                        <div class="col-md-1 mr-5 mb-3 " >
                            {{-- triggered from edit webcam save snapshot  --}}
                            <button id="reset" class="mb-2 mr-2 mt-1 btn-icon btn-icon-only btn-pill btn btn-light position-absolute" wire:click="originalImage()" style="z-index: 999999999999; display:none;"><i class="pe-7s-refresh btn-icon-wrapper"> </i></button>
                         
                            
                            <div  id="update-profileCamera" class="mx-auto " style="height: 130px; width: 130px; background-color: #cfcfcf; border-radius:5%;  z-index:1">
                                @if ($updated_image)
                        ...
                        <div class="col-lg-2 align-self-center">
                            <div class="d-flex flex-column  ">
                                <button type="button" class="btn btn-info px-5 mb-3" data-toggle="modal" data-target="#editWebcam" data-backdrop="static" data-keyboard="false" onclick="update_configure()">Take a Photo</button>
        ...
        <button class="btn btn-info px-5 py-2 mb-5 float-right" wire:click="update()">Save Changes</button>
        <button class="btn btn-secondary px-5 py-2 mb-5 mr-3 float-right" wire:click="listMode()">Back to Employee List</button>
