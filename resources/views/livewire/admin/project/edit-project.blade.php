<div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#project_type').on('select2:unselect', function (e) {
                let data = $(this).val();
                 @this.set('project_type', data);
            });
            $('#project_type').on('select2:opening', function (e) {
                let data = $(this).val();
                 @this.set('project_type', data);
            });  
             $('#project_type').on('select2:clear', function (e) {
                let data = $(this).val();
                 @this.set('project_type', data);
            });
            // let firstdata =   $('#project_type').select2().val();
            //      @this.set('project_type', firstdata);
